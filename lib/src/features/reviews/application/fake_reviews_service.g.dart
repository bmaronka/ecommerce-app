...
String _$reviewsServiceHash() => r'c8f3a8e799c05cbd70f72d2fac23400d91249cbc';

/// See also [reviewsService].
@ProviderFor(reviewsService)
final reviewsServiceProvider = Provider<FakeReviewsService>.internal(
  reviewsService,
...
typedef ReviewsServiceRef = ProviderRef<FakeReviewsService>;
